...
def config():
    ...
    parser.add_argument("--my-verkey", **environ_or_required("ARIES_MY_PUBLIC_KEY"))
    parser.add_argument("--my-sigkey", **environ_or_required("ARIES_MY_PRIVATE_KEY"))
    parser.add_argument("--port", default=os.environ.get("PORT", 3000))
